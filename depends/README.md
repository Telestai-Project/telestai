...
Telestai Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Telestai Core

**When configuring Telestai Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Telestai Core:
...
variables will be set when generating the Telestai Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
