...
Meowcoin Core. It supports cross-compilation. For more details see [description.md](description.md),
...
## Configuring Meowcoin Core

**When configuring Meowcoin Core, CMake by default will ignore the depends output.** In
...
created. To use it during configuring Meowcoin Core:
...
variables will be set when generating the Meowcoin Core buildsystem. In this case, `-DENABLE_WALLET=OFF`.
