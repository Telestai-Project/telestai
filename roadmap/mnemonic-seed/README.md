...
A command-line option (-noseed) can be passed when starting ravend and/or telestai-qt for the first time to create a wallet using the original key system that existed in Bitcoin and Telestai on Jan 3, 2019.
