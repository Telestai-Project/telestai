UNIX BUILD NOTES
====================
Some notes on how to build Telestai Core in Unix.
...
memory available when compiling Telestai Core. On systems with less, gcc can be
...
To build Telestai Core without the wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, Telestai Core can
