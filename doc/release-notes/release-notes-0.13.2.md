Meowcoin Core version 0.13.2 is now available from:

  <https://meowcoin.org/bin/meowcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update meowcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow meowcoin-tx to create v2 transactions (btcdrak)
