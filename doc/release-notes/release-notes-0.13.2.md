Telestai Core version 0.13.2 is now available from:

  <https://telestai.org/bin/telestai-core-0.13.2/>
...
- #8908 `4a974b2` Update telestai-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow telestai-tx to create v2 transactions (btcdrak)
