Download URL: https://sourceforge.net/projects/telestai/files/Telestai/telestai-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 TLS fee schedule (users still pay 0.01 TLS per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #telestai00 - #telestai99
