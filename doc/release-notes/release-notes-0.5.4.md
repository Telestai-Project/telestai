Telestai version 0.5.4 is now available for download at:
http://sourceforge.net/projects/telestai/files/Telestai/telestai-0.5.4/
...
http://gitorious.org/telestai/telestaid-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Telestai-Qt notifications under Growl 1.3.
Increase required age of Telestai-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Telestai-Qt over it. (Windows)
