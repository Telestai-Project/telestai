Telestai Core version *2.0.4.0* is now available!!
==============

  <https://github.com/TelestaiProject/Telestai/releases/tag/v2.0.4>
...
Changelog available here: <https://github.com/TelestaiProject/Telestai/commits/release_2.0.4>
