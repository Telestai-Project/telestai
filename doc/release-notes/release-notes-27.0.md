Meowcoin Core version 27.0 is now available from:

  <https://meowcoincore.org/bin/meowcoin-core-27.0/>
...
libmeowcoinconsensus
-------------------

- libmeowcoinconsensus is deprecated and will be removed for v28. This library has
  ...
  In the future, libmeowcoinkernel will provide a much more useful API that is
...
- A C++20 capable compiler is now required to build Meowcoin Core. (#28349)
...
- The CoinGrinder coin selection algorithm has been introduced to mitigate unnecessary
  ...
  elevated feerates (default: 30+ mewc/vB, based on `-consolidatefeerate`×3). (#27877)
...
- Various fixes to prevent issues where subsequent instances of Meowcoin Core would
