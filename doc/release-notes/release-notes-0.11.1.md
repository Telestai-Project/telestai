Meowcoin Core version 0.11.1 is now available from:

  <https://meowcoin.org/bin/meowcoin-core-0.11.1/>
...
(see https://github.com/meowcoin/meowcoin/pull/6795).
...
one was randomly violated by all deployed meowcoin software prior to
...
Meowcoin Core has produced compatible signatures since a28fb70e in
...
[1] On the Malleability of Meowcoin Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/meowcoin/paper_9.pdf
...
(see https://github.com/meowcoin/meowcoin/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libmeowcoinconsensus: avoid a crash in multi-threaded environments
