Telestai Core version 0.11.1 is now available from:

  <https://telestai.org/bin/telestai-core-0.11.1/>
...
(see https://github.com/Telestai-Project/telestai/pull/6795).
...
one was randomly violated by all deployed telestai software prior to
...
Telestai Core has produced compatible signatures since a28fb70e in
...
[1] On the Malleability of Telestai Transactions
Marcin Andrychowicz, Stefan Dziembowski, Daniel Malinowski, Łukasz Mazurek
http://fc15.ifca.ai/preproceedings/telestai/paper_9.pdf
...
(see https://github.com/Telestai-Project/telestai/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libtelestaiconsensus: avoid a crash in multi-threaded environments
