Meowcoin Core version *0.15.2* is now available from:

  <https://meowcoincore.org/bin/meowcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in meowcoin-tx (TheBlueMatt)
