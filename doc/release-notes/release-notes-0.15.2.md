Telestai Core version *0.15.2* is now available from:

  <https://telestaicore.org/bin/telestai-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in telestai-tx (TheBlueMatt)
