Telestai Core version 0.10.4 is now available from:

  <https://telestai.org/bin/telestai-core-0.10.4/>
...
- #6953 `43c2789` Split telestai-tx into its own package
- #6953 `dfe0d4d` Include telestai-tx binary on Debian/Ubuntu
