Telestai Core version 0.14.2 is now available from:

  <https://telestai.org/bin/telestai-core-0.14.2/>
...
(in Telestai Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate telestai-config.h as necessary (theuni)
