Meowcoin Core version 0.14.2 is now available from:

  <https://meowcoin.org/bin/meowcoin-core-0.14.2/>
...
(in Meowcoin Core 0.10.3) it has been disabled by default.
...
- #10228 `ae479bc` Regenerate meowcoin-config.h as necessary (theuni)
