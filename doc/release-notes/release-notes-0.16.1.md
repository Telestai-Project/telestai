Meowcoin Core version 0.16.1 is now available from:

  <https://meowcoincore.org/bin/meowcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting meowcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure meowcoind processes are cleaned up when tests end (sdaftuar)
