Telestai Core version 0.16.1 is now available from:

  <https://telestaicore.org/bin/telestai-core-0.16.1/>
...
- #12843 `df38b13` Test starting telestaid with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure telestaid processes are cleaned up when tests end (sdaftuar)
