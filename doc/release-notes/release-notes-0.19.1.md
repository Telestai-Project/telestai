...
Meowcoin Core version 0.19.1 is now available from:

  <https://meowcoincore.org/bin/meowcoin-core-0.19.1/>
...
From Meowcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Meowcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Meowcoin Core does not yet change appearance when
...
- #17488 fix "meowcoind already running" warnings on macOS (fanquake)
