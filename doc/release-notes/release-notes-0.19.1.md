...
Telestai Core version 0.19.1 is now available from:

  <https://telestaicore.org/bin/telestai-core-0.19.1/>
...
From Telestai Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Telestai Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Telestai Core does not yet change appearance when
...
- #17488 fix "telestaid already running" warnings on macOS (fanquake)
