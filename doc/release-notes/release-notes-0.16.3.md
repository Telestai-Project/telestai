Meowcoin Core version 0.16.3 is now available from:

  <https://meowcoincore.org/bin/meowcoin-core-0.16.3/>
...
been discovered in Meowcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` meowcoinconsensus: invalid flags error should be set to `meowcoinconsensus_err` (afk11)
