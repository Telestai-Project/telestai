Telestai Core version 0.16.3 is now available from:

  <https://telestaicore.org/bin/telestai-core-0.16.3/>
...
been discovered in Telestai Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` telestaiconsensus: invalid flags error should be set to `telestaiconsensus_err` (afk11)
