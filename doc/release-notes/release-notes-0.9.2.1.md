Meowcoin Core version 0.9.2.1 is now available from:

  https://meowcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 MEWC to 0.01 MEWC
...
- Fix "Start meowcoin on system login"
