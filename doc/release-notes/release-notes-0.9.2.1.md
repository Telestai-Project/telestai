Telestai Core version 0.9.2.1 is now available from:

  https://telestai.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 TLS to 0.01 TLS
...
- Fix "Start telestai on system login"
