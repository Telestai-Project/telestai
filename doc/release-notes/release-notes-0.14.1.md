Telestai Core version 0.14.1 is now available from:

  <https://telestai.org/bin/telestai-core-0.14.1/>
...
here:
[reducing-telestaid-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` telestai-tx input verification (awemany, jnewbery)
