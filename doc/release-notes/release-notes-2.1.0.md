Telestai Core version *2.1.0* is now available!!
==============

  <https://github.com/TelestaiProject/Telestai/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/TelestaiProject/Telestai/commits/release_2.1.0>
