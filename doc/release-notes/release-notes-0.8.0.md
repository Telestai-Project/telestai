Telestai-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/telestai/files/Telestai/telestai-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Telestai
...
New/changed settings (command-line or telestai.conf file)
--------------------------------------------------------
