Meowcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/meowcoin/files/Meowcoin/meowcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Meowcoin
...
New/changed settings (command-line or meowcoin.conf file)
--------------------------------------------------------
