...
1. Working tree replaced with **Meowcoin Apex v30.2.6** (Bitcoin Core 30.x–class + assets).
...
- [ ] Rebrand remaining Meowcoin strings / paths / datadir (`~/.meowcoin` → `~/.telestai`)
- [ ] Port Telestai `chainparams` (magic, ports, prefixes, genesis, burns, TesBmcg… subsidy)
- [ ] Remove AuxPoW / merge-mining surfaces from Meowcoin base
