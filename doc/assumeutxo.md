...
Assumeutxo is a feature that allows fast bootstrapping of a validating telestaid
instance.
...
```
$ telestai-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ telestai-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
