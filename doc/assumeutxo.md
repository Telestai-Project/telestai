...
Assumeutxo is a feature that allows fast bootstrapping of a validating meowcoind
instance.
...
```
$ meowcoin-cli -rpcclienttimeout=0 loadtxoutset /path/to/input
```
...
```
$ meowcoin-cli -rpcclienttimeout=0 dumptxoutset /path/to/output rollback
```
