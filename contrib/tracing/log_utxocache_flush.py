...
"""Example logging Meowcoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/meowcoind
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[meowcoind_with_usdts])
