...
"""Example logging Telestai Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/telestaid
...
def main(pid):
    ...
    b = BPF(text=program, usdt_contexts=[telestaid_with_usdts])
