...
BITCOIND=${BITCOIND:-$BINDIR/telestaid}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/telestai.conf}
...
then
  ...
  echo -e "To safely generate a telestai.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example telestai.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-telestai-conf.sh.
##
...
# parse the output from telestaid --help
