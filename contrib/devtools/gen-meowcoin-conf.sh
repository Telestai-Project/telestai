...
BITCOIND=${BITCOIND:-$BINDIR/meowcoind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/meowcoin.conf}
...
then
  ...
  echo -e "To safely generate a meowcoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example meowcoin.conf file in share/examples/'
...
## Generated by contrib/devtools/gen-meowcoin-conf.sh.
##
...
# parse the output from meowcoind --help
