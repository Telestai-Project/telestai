...
When complete, it will have produced `Telestai-Core.zip`.
...
apt install cpio
git clone https://github.com/telestai-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  included script. Detached signatures are available from this [repository](https://github.com/telestai-core/telestai-detached-sigs).
