...
# Extract options
function __fish_telestai_tx_get_options
...
# Extract commands
function __fish_telestai_tx_get_commands
...
complete \
    --command telestai-tx \
    --condition "not __fish_telestai_seen_cmd (__fish_telestai_tx_get_commands --commandsonly)" \
    --arguments "(__fish_telestai_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command telestai-tx \
    --arguments "(__fish_telestai_tx_get_commands)" \
    --no-files
