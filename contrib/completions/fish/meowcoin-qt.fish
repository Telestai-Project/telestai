...
complete --command meowcoin-qt --no-files

# Extract options
function __fish_meowcoinqt_get_options
...
complete \
    --command meowcoin-qt \
    --arguments "(__fish_meowcoinqt_get_options --nofiles)"
