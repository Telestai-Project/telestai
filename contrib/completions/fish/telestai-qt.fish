...
complete --command telestai-qt --no-files

# Extract options
function __fish_telestaiqt_get_options
...
complete \
    --command telestai-qt \
    --arguments "(__fish_telestaiqt_get_options --nofiles)"
