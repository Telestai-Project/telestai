...
# Extract options
function __fish_meowcoin_tx_get_options
...
# Extract commands
function __fish_meowcoin_tx_get_commands
...
complete \
    --command meowcoin-tx \
    --condition "not __fish_meowcoin_seen_cmd (__fish_meowcoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_meowcoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command meowcoin-tx \
    --arguments "(__fish_meowcoin_tx_get_commands)" \
    --no-files
