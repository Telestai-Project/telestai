...
complete --command telestaid --no-files

# Extract options
function __fish_telestaid_get_options
...
complete \
    --command telestaid \
    --arguments "(__fish_telestaid_get_options --nofiles)"
