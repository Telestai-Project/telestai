...
const std::string EXAMPLE_ADDRESS[2] = {"MEWCCore1XXXXXXXXXXXXXXXXXXXXXXXXX", "MEWCCore2XXXXXXXXXXXXXXXXXXXXXXXXX"};
...
{
    return "> telestai-cli " + methodname + " " + args + "\n";
}

std::string HelpExampleCliNamed(const std::string& methodname, const RPCArgList& args)
{
    std::string result = "> telestai-cli -named " + methodname;
