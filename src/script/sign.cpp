                     ...
                     std::vector<valtype>& ret, TxoutType& whichTypeRet, SigVersion sigversion, SignatureData& sigdata)
{
    ...
    case TxoutType::MULTISIG: {
        ...
        for (size_t i = 1; i < vSolutions.size() - 1; ++i) {
            ...
            // possible signatures that we can create. This will allow further PSMT
...
// Extracts signatures and scripts from incomplete scriptSigs. Please do not extend this, use PSMT instead
