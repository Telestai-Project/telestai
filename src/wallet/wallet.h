...
#ifndef TELESTAI_WALLET_WALLET_H
#define TELESTAI_WALLET_WALLET_H
...
public:
     ...
     * on this telestai node, and set to 0 for transactions that were created
...
public:
    ...
    /**
     * Helper function that calls AvailableCoinsAll, used to receive all coins, Assets and TLS
     */
...
#endif // TELESTAI_WALLET_WALLET_H
