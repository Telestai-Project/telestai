...
extern thread_local ThreadContext g_thread_context; // NOLINT(telestai-nontrivial-threadlocal)
// Silence nonstandard telestai tidy error "Variable with non-trivial destructor
