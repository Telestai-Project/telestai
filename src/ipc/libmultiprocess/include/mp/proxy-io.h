...
extern thread_local ThreadContext g_thread_context; // NOLINT(meowcoin-nontrivial-threadlocal)
// Silence nonstandard meowcoin tidy error "Variable with non-trivial destructor
