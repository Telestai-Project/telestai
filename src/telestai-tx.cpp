...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s telestai-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  telestai-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded telestai transaction") + "\n" +
              "  telestai-tx [options] -create [commands]   " + _("Create hex-encoded telestai transaction") + "\n" +
              "\n";
