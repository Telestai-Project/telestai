 ...
 */
#ifndef TELESTAI_UTIL_H
#define TELESTAI_UTIL_H
...
extern const char *const TELESTAI_CONF_FILENAME;
extern const char *const TELESTAI_PID_FILENAME;
...
{
    std::string s = strprintf("telestai-%s", name);
