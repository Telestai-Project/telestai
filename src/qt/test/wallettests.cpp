...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<TelestaiAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_telestai-qt -platform xcb      # Linux
//     src/qt/test/test_telestai-qt -platform windows  # Windows
//     src/qt/test/test_telestai-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = TelestaiUnits::formatWithUnit(unit, balance, false, TelestaiUnits::separatorAlways);
    ...
    // Amount input
    TelestaiAmountField* amountInput = receiveCoinsDialog.findChild<TelestaiAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: telestai:")) != -1);
