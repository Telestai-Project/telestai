...
#define STYLE_VALID "border: 1px solid #bd840a"
...
#define QAPP_APP_NAME_TESTNET4 "Meowcoin-Qt-testnet4"
#define QAPP_APP_NAME_SIGNET "Meowcoin-Qt-signet"
#define QAPP_APP_NAME_REGTEST "Meowcoin-Qt-regtest"
