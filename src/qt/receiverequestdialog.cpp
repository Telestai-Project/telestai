...
#include "config/telestai-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatTelestaiURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + TelestaiUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatTelestaiURI(info));
}
