...
{
    BOOST_CHECK(TestSplitHost("www.telestaicore.org", "www.telestaicore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.telestaicore.org]", "www.telestaicore.org", 0));
    BOOST_CHECK(TestSplitHost("www.telestaicore.org:80", "www.telestaicore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.telestaicore.org]:80", "www.telestaicore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.telestaicore.org:65536", "www.telestaicore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.telestaicore.org:0", "www.telestaicore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.telestaicore.org:", "www.telestaicore.org:", 0, false));
}
