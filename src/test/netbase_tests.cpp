...
{
    BOOST_CHECK(TestSplitHost("www.meowcoincore.org", "www.meowcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.meowcoincore.org]", "www.meowcoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.meowcoincore.org:80", "www.meowcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.meowcoincore.org]:80", "www.meowcoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.meowcoincore.org:65536", "www.meowcoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.meowcoincore.org:0", "www.meowcoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.meowcoincore.org:", "www.meowcoincore.org:", 0, false));
}
