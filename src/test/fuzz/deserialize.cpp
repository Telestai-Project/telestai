...
FUZZ_TARGET_DESERIALIZE(psmt_input_deserialize, {
    PSMTInput psmt_input;
    DeserializeFromFuzzingInput(buffer, psmt_input);
})
FUZZ_TARGET_DESERIALIZE(psmt_output_deserialize, {
    PSMTOutput psmt_output;
    DeserializeFromFuzzingInput(buffer, psmt_output);
})
