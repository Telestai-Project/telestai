...
BOOST_FIXTURE_TEST_SUITE(miner_tests, TestingSetup)
    ...
    struct
    {
        ...
        {1, 0x3b1c71}, {3, 0x10163b}, {2, 0x3ad829}, 
        {2, 0x18171c}, {2, 0x4d4934}, {4, 0x20db6f}
    };
    ...
    void TestPackageSelection(const CChainParams &chainparams, CScript scriptPubKey, std::vector<CTransactionRef> &txFirst)
    {
        ...
        tx.vout.resize(1);
        tx.vout[0].nValue = 351000000LL - 1000;
        ...
        tx.vout[0].nValue = 351000000LL - 10000;
        uint256 hashMediumFeeTx = tx.GetHash();
        mempool.addUnchecked(hashMediumFeeTx, entry.Fee(10000).Time(GetTime()).SpendsCoinbase(true).FromTx(tx));

        // This tx has a high fee, but depends on the first transaction
        tx.vin[0].prevout.hash = hashParentTx;
        tx.vout[0].nValue = 351000000LL - 1000 - 50000; // 50k satoshi fee
        ...
        tx.vout[0].nValue = 351000000LL - 1000 - 50000; // 0 fee
        ...
        tx.vout[0].nValue = 351000000LL - 1000 - 50000 - feeToUse;
        ...
        tx.vout.resize(2);
        tx.vout[0].nValue = 351000000LL - 100000000;
        ...
        tx.vout[0].nValue = 351000000LL - 100000000 - feeToUse;
...
//
//                   if(processBlock) {
//                         std::cout << "nounce is 0x" << std::hex << shared_pblock->nNonce << std::dec << "\n" << std::endl;                         
//                         std::cout << "extra nounce is " << j << "\n" << std::endl;
//                         break;
//                   }
//              }
//          }
