...
By default, telestaid will dump mempool on shutdown and
...
class MempoolPersistTest(TelestaiTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give telestaid a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent telestaid from writing mempool.dat to disk. Verify that `savemempool` fails")
