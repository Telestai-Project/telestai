...
# The block reward of coinbaseoutput.nValue (50) MEWC/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 MEWC/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"meowcoin-cli -h\" for help or \"meowcoin-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `meowcoin-cli getblockchaininfo`")
        ...
        # Prevent meowcoin-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and meowcoin-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and meowcoin-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (MEWC/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (MEWC/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 MEWC) to the default wallet.
            ...
            # Test meowcoin-cli -generate with -rpcwallet in multiwallet mode.
