...
# The block reward of coinbaseoutput.nValue (50) TLS/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 TLS/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"telestai-cli -h\" for help or \"telestai-cli listwallets\" to see "
...
class TestBitcoinCli(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `telestai-cli getblockchaininfo`")
        ...
        # Prevent telestai-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and telestai-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and telestai-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (TLS/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (TLS/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 TLS) to the default wallet.
            ...
            # Test telestai-cli -generate with -rpcwallet in multiwallet mode.
