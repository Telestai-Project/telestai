...
class TestTelestaiCli(TelestaiTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `telestai-cli getinfo`")
        ...
        self.log.info("Compare responses from `telestai-cli -getinfo` and the RPCs data is retrieved from.")
