...
class RawTransactionsTest(TelestaiTestFramework):
    ...
    def run_test(self):
        ...
        raw_match = self.nodes[2].createrawtransaction([], {self.nodes[2].getnewaddress():351})
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid telestai address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
        ...
        # make sure funds are received at node1
        assert_equal(oldBalance+Decimal('352.10000000'), self.nodes[0].getbalance())
        ...
        self.nodes[0].generate(1)
        self.sync_all()
        assert_equal(oldBalance+Decimal('351.19000000'), self.nodes[0].getbalance()) #0.19+block reward
