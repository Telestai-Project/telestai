...
"""Verify that starting telestai with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start telestai with -h for help text")
        ...
        self.log.info("Start telestai with -version for version information")
        ...
        self.log.info("Start telestaid with -fakearg to make sure it does not start")
