...
"""Verify that starting meowcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start meowcoin with -h for help text")
        ...
        self.log.info("Start meowcoin with -version for version information")
        ...
        self.log.info("Start meowcoind with -fakearg to make sure it does not start")
